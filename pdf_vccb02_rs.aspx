...
<%@ Page Language="C#" Debug="true"%>
    <script language="c#" runat="server">     
        ...
        public void Page_Load()
        {
            ...
            //中一刀
            float width = doc1.PageSize.Width;   //  21.59cm
            float height = doc1.PageSize.Height/2;   //  13.97cm
        ...
        public void Content(ref iTextSharp.text.pdf.PdfContentByte cb, float width, float height, iTextSharp.text.pdf.BaseFont bfChinese, Vccb vccb)
        {
            ...
            */
            ...
            for (int i = 0; i < vccb.bbs.Length && bbsH>0; i++)
            {
                ...
                cb.ShowTextAligned(iTextSharp.text.pdf.PdfContentByte.ALIGN_LEFT, vccb.bbs[i].mm, width / (float)21.59 * (float)2.4, height / (float)13.97 * (float)bbsH, 0);
                cb.ShowTextAligned(iTextSharp.text.pdf.PdfContentByte.ALIGN_LEFT, vccb.bbs[i].dd, width / (float)21.59 * (float)3, height / (float)13.97 * (float)bbsH, 0);
                cb.ShowTextAligned(iTextSharp.text.pdf.PdfContentByte.ALIGN_LEFT, vccb.bbs[i].track, width / (float)21.59 * (float)3.7, height / (float)13.97 * (float)bbsH, 0);
                cb.ShowTextAligned(iTextSharp.text.pdf.PdfContentByte.ALIGN_LEFT, vccb.bbs[i].number, width / (float)21.59 * (float)4.6, height / (float)13.97 * (float)bbsH, 0);
                cb.ShowTextAligned(iTextSharp.text.pdf.PdfContentByte.ALIGN_LEFT, vccb.bbs[i].product, width / (float)21.59 * (float)6.5, height / (float)13.97 * (float)bbsH, 0);
